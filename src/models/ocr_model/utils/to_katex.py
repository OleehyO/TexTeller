...
if __name__ == "__main__" :
    test = r'''\[\textbf{a}(\textbf{\emph{i}},\textbf{\emph{j}})=(\textbf{\emph{a}}_{1}( \textbf{\emph{i}},\textbf{\emph{j}}),\textbf{\emph{a}}_{2}(\textbf{\emph{i}}, \textbf{\emph{j}}),\cdots,\textbf{\emph{a}}_{n}(\textbf{\emph{i}},\textbf{\emph {j}}))\]'''
    res = to_katex(test)
    print(res)